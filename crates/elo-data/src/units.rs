...
pub static UNITS: &[UnitDef] = &[
    ...
    UnitDef::linear(
        "μm",
        &["μm", "micrometer", "micrometers", "micron", "microns"],
        Dimension::Length,
        1e-6,
    ),
    UnitDef::linear(
        "nm_len",
        &["nanometer", "nanometers", "nanometre"],
        Dimension::Length,
        1e-9,
    ),
    UnitDef::linear(
    ...
    UnitDef::linear(
        "sqm",
        &["sq m", "m²", "m2", "square meter", "square meters"],
        Dimension::Area,
        1.0,
    ),
    UnitDef::linear(
    ...
    UnitDef::linear(
        "sqin",
        &["sq in", "in²", "in2", "square inch", "square inches"],
        Dimension::Area,
        0.00064516,
    ),
    UnitDef::linear(
        "sqft",
        &["sq ft", "ft²", "ft2", "square foot", "square feet"],
        Dimension::Area,
        0.09290304,
    ),
    UnitDef::linear(
        "sqyd",
        &["sq yd", "yd²", "yd2", "square yard", "square yards"],
        Dimension::Area,
        0.83612736,
    ),
    UnitDef::linear(
        "sqmi",
        &["sq mi", "mi²", "mi2", "square mile", "square miles"],
        Dimension::Area,
        2589988.110336,
    ),
    UnitDef::linear(
    ...
    UnitDef::linear(
        "mps",
        &["m/s", "mps", "meter per second", "meters per second"],
        Dimension::Speed,
        1.0,
    ),
    UnitDef::linear(
